...
export default function EmployeesComp({ users, fullName, deleted, setFullName, setDeleted }) {
  return (
    <div className="main-content">
      ...
      <div className="container-fluid mt--7">
        <div className="row">
          ...
          <div className="col-3">
            <FilterComp fullName={fullName} deleted={deleted} setFullName={setFullName} setDeleted={setDeleted}/>
          </div>
        </div>
      </div>
    </div>
